...
<body>
    <p class="text-center fs-1"><a href="index.php" ><svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-reply-all" viewBox="0 0 16 16">
